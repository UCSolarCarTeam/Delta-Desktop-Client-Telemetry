...
, ui_(ui)
{
   ui_.show();
    ...
    connect(&presenter_, SIGNAL(motorVelocityRpmReceived(double)),
            this, SLOT(motorVelocityRpmReceived(double)));
    connect(&presenter_, SIGNAL(motorVoltageRealReceived(double)),
            this, SLOT(motorVoltageRealReceived(double)));
    connect(&presenter_, SIGNAL(motorCurrentRealReceived(double)),
            this, SLOT(motorCurrentRealReceived(double)));
    connect(&presenter_, SIGNAL(backEmfImaginaryReceived(double)),
            this, SLOT(backEmfImaginaryReceived(double)));
    connect(&presenter_, SIGNAL(ipmHeatSinkTempReceived(double)),
            this, SLOT(ipmHeatSinkTempReceived(double)));
    connect(&presenter_, SIGNAL(dspBoardTempReceived(double)),
            this, SLOT(dspBoardTempReceived(double)));
    connect(&presenter_, SIGNAL(dcBusAmpHoursReceived(double)),
            this, SLOT(dcBusAmpHoursReceived(double)));
    connect(&presenter_, SIGNAL(receivedErrorCountReceived(double)),
            this, SLOT(receivedErrorCountReceived(double)));
    connect(&presenter_, SIGNAL(transmittedErrorCountReceived(double)),
            this, SLOT(transmittedErrorCountReceived(double)));
    ...
    connect(&presenter_, SIGNAL(batteryVoltageReceived(int)),
            this, SLOT(batteryVoltageReceived(int)));
    connect(&presenter_, SIGNAL(batteryCurrentReceived(int)),
            this, SLOT(batteryCurrentReceived(int)));
    connect(&presenter_, SIGNAL(batteryVoltageThresholdRisingReceived(int)),
            this, SLOT(batteryVoltageThresholdRisingReceived(int)));
    connect(&presenter_, SIGNAL(batteryVoltageThresholdFallingReceived(int)),
            this, SLOT(batteryVoltageThresholdFallingReceived(int)));
